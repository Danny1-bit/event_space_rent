...
const EditClientHall = ({ isOpen, onRequestClose, client, refreshClients }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`http://localhost:3030/api/v1/client-hall/update-client/${client._id}`, {
            ...
            toast.error("Error updating client: " + error.response.data.message);
        }
    };
